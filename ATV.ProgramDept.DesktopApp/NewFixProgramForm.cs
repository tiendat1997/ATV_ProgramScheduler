...
namespace ATV.ProgramDept.DesktopApp
{
    ...
    {
        private readonly ManageFixProgramForm fixProgramForm;
        private readonly IProgramRepository _programRepository;
        public NewFixProgramForm(ManageFixProgramForm parentForm)
        {
            fixProgramForm = parentForm;
            _programRepository = new ProgramRepository();
            InitializeComponent();
        }

        private void NewFixProgramForm_Load(object sender, EventArgs e)
        {            
        }
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (CheckValidate(name, duration, performBy))
                {
                    ...
                    {
                        fixProgramForm.ReloadFixProgram();
                        Close();
                    }
                }                                
            }
        ...
        private void NewFixProgramForm_FormClosed(object sender, FormClosedEventArgs e)
        {
