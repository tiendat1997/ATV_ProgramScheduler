...
{
    public partial class ScheduleTemplateDetailForm : Form
    {
        private byte DayOfWeek { get; set; }
        private string Title { get; set; }
        public ScheduleTemplateDetailForm(string title, byte dayOfWeek)
        {
            InitializeComponent();
            Title = title;
            lblTitle.Text = Title;
        ...
        {
            dgvScheduleTemplateDetails.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
        }
        ...
        private void ScheduleTemplateDetailForm_Load(object sender, EventArgs e)
        {
        ...
        private void ScheduleTemplateDetailForm_Resize(object sender, EventArgs e)
        {
            pnlHeader.Width = flpContent.Width;
            pnlHeader.Height = flpContent.Height;

            dgvScheduleTemplateDetails.Width = flpContent.Width;
            dgvScheduleTemplateDetails.Height = flpContent.Height;
        }
    }
}
